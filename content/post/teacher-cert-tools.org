...
date: 2020-08-06T16:07:26-04:00
tags:
- pedagogy
- CSEd
categories:
...
[[https://bigbluebutton.org/][Big Blue Button]] is an open source alternative to Zoom and it's better
suited for education but it's just not quite there yet.

Instead of the Zoom chat, we decided to use Slack. Zoom's slack only
...
In addition to the general class chat we had channels like #git-fu,
#java-fu, #fall-is-coming to discuss COVID-19 and the public schools,
...
community. Having some fun channels like #duckygram and
#cs-educationy-goodness  set a light tone. Every day, Alex would wait
