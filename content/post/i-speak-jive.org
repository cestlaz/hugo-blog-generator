...
ownd take. Not only dir the team cast them on the spot and follow
...
So how is jive from Airplane! related to The Sweedish Chef?
...
the encheferizer which translated into Sweedish Chef talk.

Over time, the list of filters grew. Some were silly, some fun, and,
yes, some were kindof offensive.
...
feel as though I shoudl write something like: Do you remember using
...
Fortunately, I found [[- https://github.com/hyperrealm/talkfilters][this]] repo. It's an implementaiton of a whole
bunch of filters:
